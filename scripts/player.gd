...
@export_range(1, 10, 1, "suffix:px/s") var BulletSpeed = 2
...
@export_range(0, 5, 0.5, "suffix:s") var shoot_timer: float = 1
## Can your character jump a second time while still in the air?
@export var double_jump: bool = false
## the ammount of knockback bullets have
@export var BulletKnockBack: float  = 1
...
#same thing for shootihg
var shoot_buffer_timer: float = 0
...
func Shoot(Pos): 
	...
	bullet.linear_velocity = (Pos - position) * BulletSpeed
